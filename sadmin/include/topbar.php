     ...
     <ul class="navbar-nav ml-auto">
         ...
         <li class="nav-item dropdown no-arrow">
             <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                 aria-haspopup="true" aria-expanded="false">
                 <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $_SESSION['sadmin_email']; ?></span>
             ...
             <div class="modal-body">
                 ...
                 $hod_ID = $_SESSION['sadmin_id'];
                        ...
                        if (isset($_POST['update'])) {
                            ...
                            if (mysqli_query($con,"UPDATE `tbl_users` SET `fname`='$fname',`lname`='$lname',`email`='$email',
                            `phoneNumber`='$phone' WHERE uid='$hod_ID'")) {
                                $msg = "Edited";
                            }else {
                                $error = "not edited";
                            }
