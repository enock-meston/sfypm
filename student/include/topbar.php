             ...
             <div class="modal-body">
                 ...
                 $student_ID = $_SESSION['sID'];
                        ...
                        if (isset($_POST['update'])) {
                            ...
                            if (mysqli_query($con,"UPDATE `tbl_students` SET `email`='$email',`fname`='$fname',`lname`='$lname',`phoneNumber`='$phone' WHERE sID='$student_ID'")) {
                                $msg = "Edited";
                            }else {
                                $error = "not edited";
                            }
                        ...
                        $query = mysqli_query($con,"SELECT * FROM `tbl_students` WHERE sID = '$student_ID'");
                 ...
                 <form method="POST">
                     <div class="form-group">
                         <input type="text" disabled value="<?php echo $row['reg_number'];?>" class="form-control">
                     </div>
                     <div class="form-group">
                         <input type="text" disabled value="<?php echo $row['Department'];?>" class="form-control">
                     </div>
                     <div class="form-group">
